...
public class RemoveOfficeUserQueryHandler : IRequestHandler<RemoveOfficeUserQuery, ErrorOr<Office>>
{
    private readonly IOfficeRepository _officeRepository;
    private readonly IUserRepository _userRepository;
    private readonly UserManager<User> _userManager;

    public RemoveOfficeUserQueryHandler(
    ...
    public async Task<ErrorOr<Office>> Handle(RemoveOfficeUserQuery request, CancellationToken cancellationToken)
    {
